...
function updateParallax() {
    ...
    if (layer) layer.style.left = value * 2 + 'px';
...
(function(){
  ...
  style.textContent = `
    ...
    .project-card, .tech-item { will-change:transform,box-shadow; }
    .project-card:focus { outline: 2px solid rgba(255,215,0,.7); outline-offset: 4px; }
    .tech-item:hover, .tech-item:focus { transform: translateY(-10px) scale(1.02); box-shadow: 0 18px 40px rgba(0,0,0,.45); }
